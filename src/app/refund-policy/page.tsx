                    ...
                    <div className="flex flex-col md:flex-row gap-12 lg:gap-24 items-start">
                        <div className="w-full md:w-[60%]">
                            <div className="space-y-6 text-[#4A4A4A]">
                                <h1 className="lg:text-[40px] text-4xl font-semibold text-[#0B2E3C] fadeUp mb-8">Refund <span className="text-[#2980C4]">Policy</span></h1>
                        ...
                        <div className="w-full md:w-[35%] flex justify-end">
                            <div className="hidden md:block fadePopup w-full max-w-[416px]">
                                <Image
                                    src="/images/refund-policy.png"
