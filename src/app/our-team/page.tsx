...
export default function OurTeam() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[300px] md:h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 top-19 md:top-28 lg:top-32 text-center text-white">
          ...
          <p className="text-[11px] md:text-[14px] font-medium leading-3 lg:leading-5">
            Our counselors and consultants bring years of experience in global
            healthcare education counselling <br className="md:block hidden" />{" "}
            to ensure you don’t just get an admission, but a clear path to
            becoming a doctor.
          </p>
        </div>
      </section>
      ...
      <section id="connect-counselor" className="bg-[#F4F7F8] py-10 md:py-16 lg:py-20">
        <div className="container mx-auto px-3 md:px-4">
          <CounselorSection />
        </div>
      </section>
