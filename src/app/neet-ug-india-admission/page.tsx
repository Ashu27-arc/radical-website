            ...
            <section className="lg:py-45 md:py-36 py-20 relative overflow-hidden z-2 bg-[url('/images/neet-ug-india-hero.webp')] bg-cover bg-center bg-no-repeat">
                <div className="container px-3 md:px-4 fadeUp">
                    <div className="w-full lg:w-4/10 md:8/10 md:text-left text-center">
                        ...
                        <p className="text-white text-[16px] font-normal font-weight-400m-0 p-0 text-justify">
                            Radical Education is your personalised gateway to
                            <br /> a successful medical career. Get expert guidance,
                            <br /> clear processes, and authentic information to
                            <br /> secure your MBBS seat with confidence.</p>
                    </div>
                </div>
            </section>
