...
export default function MbbsInIndiaPage() {
    ...
    return (
        <>
            <section className="lg:py-50 md:py-40 py-20 relative overflow-hidden z-2 bg-[url('/images/bds/bds-hero.webp')] bg-cover bg-right bg-no-repeat">
                ...
                <div className="container px-3 md:px-4 fadeUp">
                    <div className="w-full lg:w-4/10 md:8/10 mx-auto text-center">
                        <h1 className="uppercase lg:text-5xl text-4xl font-bold text-white lg:mb-6 mb-4">BDS IN INDIA</h1>
            ...
            <section className="lg:py-15 py-10 overflow-hidden">
                <div className="container px-3 md:px-4">
                    <div className="flex md:flex-row flex-col md:gap-2 items-end">
                        ...
                        <div className="w-full lg:w-4/12 md:4/10 fadeRight">
                            <div className="flex items-center">
                                ...
                                <Image src="/images/intere.webp" alt="" className="md:max-w-[180px] max-w-[160px] relative z-1"/>
                            </div>
                        </div>
                    </div>
                    <div className="lg:p-15 p-10 rounded-xl bg-[#DFF1FF] mb-10">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-10 gap-4">
