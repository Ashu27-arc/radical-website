                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4 lg:gap-10 mb-16">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <div className="text-center text-xs text-[#0B2E3C] group-hover:text-white! transition-colors duration-300 mb-6">Discover a world where you can experience a life you have never experienced and become what you have never imagined. </div>
