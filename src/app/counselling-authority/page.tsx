        ...
        <>
            <section className="lg:pb-15 lg:pt-30 py-10 overflow-hidden text-[#4A4A4A]">
                <div className="container px-3 md:px-4">
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 md:gap-8 gap-6 mt-10 mb-20">
                        {universities.map((item) => (
                            <Link key={item.id} href={item.url} className="group flex flex-col items-center text-center fadeUp">
                                ...
                                <p className="mt-2 text-sm md:text-lg text-[#287FC4] font-semibold leading-tight">
                                    {item.title}
                                </p>
                            </Link>
                        ))}
