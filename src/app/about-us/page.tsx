        ...
        <div className="container mx-auto px-4 md:px-8 w-full">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-8 md:gap-6 items-center">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 relative z-10"> 
                <div className="text-center rounded-lg p-3 sm:p-4">
                  <h3 className="text-3xl sm:text-4xl md:text-2xl md:text-3xl font-bold mb-1">100%</h3>
                  <p className="text-xs sm:text-sm md:text-xs opacity-90">Rate of Success</p>
                </div>
                <div className="text-center rounded-lg p-3 sm:p-4">
                  <h3 className="text-3xl sm:text-4xl md:text-2xl md:text-3xl font-bold mb-1">15783+</h3>
                  <p className="text-xs sm:text-sm md:text-xs opacity-90">Student Counselled</p>
                </div>
                <div className="text-center rounded-lg p-3 sm:p-4">
                  <h3 className="text-3xl sm:text-4xl md:text-2xl md:text-3xl font-bold mb-1">12+</h3>
                  <p className="text-xs sm:text-sm md:text-xs opacity-90">Year of Experiences</p>
                </div>
                <div className="text-center rounded-lg p-3 sm:p-4">
                  <h3 className="text-3xl sm:text-4xl md:text-2xl md:text-3xl font-bold mb-1">55+</h3>
                  <p className="text-xs sm:text-sm md:text-xs opacity-90">Team Strength</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="md:w-2/3">
              <div className="border-l-4 border-[#00CFB2] pl-4 md:pl-6 mb-6 md:mb-8">
                <p className="text-sm sm:text-base md:text-base text-gray-600 leading-relaxed">
                  Choosing The Right College Is A Crucial Decision That Can Shape Your Future Career<br /> 
                  Journey. At Radical Education, We Understand The Importance Of This Decision<br /> 
                  And Aim To Make The Process As Seamless And Effortless As Possible For You.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  {/* Card 1 */}
                  <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                    {/* Image with Overlay Number */}
                    <div className="relative h-40 sm:h-36 w-full">
                      <img 
                        src="/images/about/card-1.webp" 
                        alt="Comprehensive Career Support" 
                        className="w-full h-full object-cover"
                      />
                      <div className="absolute top-3 left-3 w-10 h-10 sm:w-12 sm:h-12 bg-[#00D900] rounded-full flex items-center justify-center text-white text-lg sm:text-xl font-bold shadow-lg">
                        1
                      </div>
                    </div>
                    
                    <div className="p-5 sm:p-6">
                      <h3 className="text-lg sm:text-xl font-bold text-[#00D900] mb-2">
                        Comprehensive Career Support
                      </h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                        Upon completing the course, we continue to provide 
                        support to ensure students move towards a more 
                        promising future with comprehensive guidance and 
                        assistance throughout their career journey.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div className="relative h-40 sm:h-36 w-full">
                      <img 
                        src="/images/about/card-3.webp" 
                        alt="Impartial Advice" 
                        className="w-full h-full object-cover"
                      />
                      <div className="absolute top-3 left-3 w-10 h-10 sm:w-12 sm:h-12 bg-[#D9A500] rounded-full flex items-center justify-center text-white text-lg sm:text-xl font-bold shadow-lg">
                        3
                      </div>
                    </div>
                    
                    <div className="p-5 sm:p-6">
                      <h3 className="text-lg sm:text-xl font-bold text-[#D9A500] mb-2">
                        Impartial Advice
                      </h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                        We are dedicated to assisting students on their paths 
                        to career progression and personal development, free 
                        from any prejudices. Our unbiased guidance ensures 
                        that every student receives honest recommendations 
                        tailored to their unique goals and aspirations.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div className="relative h-40 sm:h-36 w-full">
                      <img 
                        src="/images/about/card-2.webp" 
                        alt="Stay Informed" 
                        className="w-full h-full object-cover"
                      />
                      <div className="absolute top-3 left-3 w-10 h-10 sm:w-12 sm:h-12 bg-[#0B3D5E] rounded-full flex items-center justify-center text-white text-lg sm:text-xl font-bold shadow-lg">
                        2
                      </div>
                    </div>
                    
                    <div className="p-5 sm:p-6">
                      <h3 className="text-lg sm:text-xl font-bold text-[#0B3D5E] mb-2">
                        Stay Informed
                      </h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                        Receive prompt alerts and updates regarding admissions, 
                        assignments, and fee deadlines, along with other essential 
                        information to keep you on track with all important 
                        academic milestones and requirements.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 items-stretch">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden border border-gray-100 p-6 sm:p-8 relative">
              ...
              <div className="mt-12 sm:mt-16">
                <h3 className="text-xl sm:text-2xl font-bold text-[#0B2E3C] mb-3 sm:mb-4">Mission</h3>
                <div className="w-full h-0.5 bg-[#000000]/25 mb-3 sm:mb-4"></div>
                <p className="text-gray-600 leading-relaxed text-sm">
                  Radical Education Welcomes Students From All Over India Seeking Guidance On Management, Engineering, And 
                  Medical Streams Of Study In India And Across The World. We Understand How Complex The Research Process May Be 
                  For You, Irrespective Of Which Phase You Are In. We Aim To Ensure That All Students In India Possess The Knowledge 
                  To Make The Right Decision About Their Lives.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg overflow-hidden border border-gray-100 p-6 sm:p-8 relative">
              ...
              <div className="mt-12 sm:mt-16">
                <h3 className="text-xl sm:text-2xl font-bold text-[#0B2E3C] mb-3 sm:mb-4">Vision</h3>
                <div className="w-full h-0.5 bg-[#000000]/25 mb-3 sm:mb-4"></div>
                <p className="text-gray-600 leading-relaxed text-sm">
                  Imagine An India Where Every Single Child Succeeds. They Exhibit The Wisdom, Resources, And Facilities To Wholly 
                  Navigate Their Academic Endeavors And Across The World. We Envision The Benefits Of Advanced Technology, Which Helps Them Make 
                  Informed Choices About Their Lives. This Unlocks Their True Potential So That They Can Achieve Something 
                  Substantial For Themselves As Well As For The Nation. We Envision A Learning Culture With Adaptable, 
                  Empowered Youngsters Who Ensure That Their Aspirations Take Flight.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-3 md:mb-4">Our Expertise:</h3>
