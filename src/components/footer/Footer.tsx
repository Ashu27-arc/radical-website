              ...
              <ul className="space-y-4 text-xs sm:text-sm">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className='text-center sm:text-left'>
                    C-56/30, 3rd Floor, Sector 62, Noida, Uttar Pradesh
                  </span>
                </li>
              </ul>
            </div>
