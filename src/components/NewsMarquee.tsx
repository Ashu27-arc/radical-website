...
export default function NewsMarquee() {
  ...
  return (
    <div className="bg-[#005A89] text-white flex items-center md:gap-4 gap-3 md:pr-4 pr-3 py-6 overflow-hidden">
      <div
        ref={marqueeRef}
      ...
      >
        ...
        >
          ...
          <i className="icon-wrapper">
            <svg className="icon-svg" width="24" height="24" viewBox="0 0 31 31" fill="none">
              <path
