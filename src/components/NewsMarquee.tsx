...
export default function NewsMarquee() {
  ...
  return (
    <div className="bg-[#053B59] text-white flex items-center md:gap-4 gap-3 md:pr-4 pr-3 py-6 overflow-hidden">
      <div
        ref={marqueeRef}
      ...
      >
          <Button size='small' className='bg-[#005A8B]! border-[#005A8B]! py-1.5! md:py-2.5! md:pr-3! pr-1.5! pl-2! md:pl-3! gap-2' rounded>
