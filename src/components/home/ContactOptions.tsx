        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    ...
                    <div className="absolute bottom-2 left-2 md:left-auto md:right-2 w-44 h-44 bg-[#8FB583] rounded-full -translate-x-16 md:translate-x-16 translate-y-16 transition-all duration-500 ease-in-out group-hover:scale-125 group-hover:rotate-6"></div>
                    ...
                    <i className="absolute bottom-6 left-6 md:left-auto md:right-6 z-10 transition-all duration-500 group-hover:scale-110 group-hover:-rotate-6"> 
                        <svg width="50" height="50" viewBox="0 0 109 109" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                    ...
                    <div className="absolute bottom-2 left-2 w-44 h-44 bg-[#6F98C8] rounded-full -translate-x-16 translate-y-16 transition-all duration-500 ease-in-out group-hover:scale-125 group-hover:rotate-6"></div>

                    <i className="absolute bottom-6 left-6 z-10 transition-all duration-500 group-hover:scale-110 group-hover:-rotate-6">           
                        <svg width="60" height="60" viewBox="0 0 131 120" fill="none" xmlns="http://www.w3.org/2000/svg">
