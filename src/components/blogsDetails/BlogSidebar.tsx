                ...
                <div className="bg-[#E1F2FF] p-4 sm:p-5 md:p-6 rounded-lg transition-transform hover:scale-[1.01] duration-300 shadow-sm">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <label htmlFor="consent" className="text-[14px] text-[#787878]">I consent to receiving calls, Whatsapp messages and Google RCS from Edwise to Assist with this Enquiry.</label>
                        </div>
