        ...
        <section className="relative bg-gradient-to-r from-[#DEFFFA] to-[#AAE1FF] overflow-hidden p-4 lg:p-10 md:p-6 rounded-[30px] font-poppins">
            <div className="relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-30 md:gap-6 gap-10 justify-items-center">
                    ...
                    {/* Left Content */}
                    <div className="">
                        <h2 className="text-3xl md:text-[28px] font-semibold text-gray-900 mb-6">
                        ...
                        <p className="text-[16px] font-normal text-black lg:mb-24 mb-10 max-w-xl">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex items-start gap-5">
                                <div className="flex-shrink-0 w-11 h-11 md:w-16 md:h-16 bg-white rounded-[34px] flex items-center justify-center shadow-md">
                                    <Image src="/icons/location.png" alt="Location Icon" width={28} height={28} className="object-contain h-[17px] w-[17px] md:h-[28px] md:w-[28px]" />
                                </div>
                                <div>
                            ...
                            <div className="flex flex-col lg:flex-row gap-8">
                                <div className="flex items-start gap-5">
                                    <div className="flex-shrink-0 w-11 h-11 md:w-16 md:h-16 bg-white rounded-[34px] flex items-center justify-center shadow-md">
                                        <Image src="/icons/phone.png" alt="Phone Icon" width={28} height={28} className="object-contain h-[17px] w-[17px] md:h-[28px] md:w-[28px]" />
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-start gap-5">
                                    <div className="flex-shrink-0 w-11 h-11 md:w-16 md:h-16 bg-white rounded-[34px] flex items-center justify-center shadow-md">
                                        <Image src="/icons/mail.png" alt="Mail Icon" width={28} height={28} className="object-contain h-[17px] w-[17px] md:h-[28px] md:w-[28px]" />
                                    </div>
                                    <div>
