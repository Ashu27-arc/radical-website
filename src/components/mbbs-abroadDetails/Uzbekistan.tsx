...
const Russia = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative text-white py-20 lg:py-50 px-6 overflow-hidden" style={{
      ...
      <div className="container mx-auto py-10 lg:py-16 px-6">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2 relative flex flex-col items-center lg:block mt-10 lg:mt-16">
            <div className="bg-[#E3F4F3] rounded-lg shadow-lg p-8 relative overflow-hidden w-full max-w-md lg:w-90 min-h-[15rem] lg:h-60 flex flex-col justify-center items-center text-center mx-auto">
              ...
              <div className="relative z-10 flex flex-col justify-center items-center h-full">
                <h3 className="text-lg lg:text-xl font-bold text-gray-800 mb-6 leading-tight text-left text-justify">
                ...
                <div className="mt-6">
                  <button className="bg-gradient-to-r from-[#28C4B4] to-[#287FC4] hover:from-[#28C4B4] hover:to-[#287FC4] text-white font-semibold py-3 lg:py-4 px-6 lg:px-8 rounded-full transition-all duration-300 text-sm lg:text-base">
                    BOOK CONSULTATION
                  </button>
                </div>
              </div>
            ...
            <div className="mt-6 lg:mt-0 relative lg:absolute lg:-right-28 lg:top-1/2 transform translate-y-0 lg:-translate-y-1/2 z-20">
              <Image
                src="/images/study-abroad/main-content.webp"
                alt="Medical consultant"
                width={300}
                height={300}
                className="object-contain w-64 lg:w-[300px]"
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full border-4 border-cyan-300 bg-white flex items-center justify-center mb-4">
                <Image src="/images/study-abroad/logos/u.webp" alt="First Moscow State Medical University" width={80} height={80} className="object-contain w-14 h-14 lg:w-20 lg:h-20" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full border-4 border-cyan-300 bg-white flex items-center justify-center mb-4">
                <Image src="/images/study-abroad/logos/u-1.webp" alt="Kazan Federal University" width={80} height={80} className="object-contain w-14 h-14 lg:w-20 lg:h-20" />
              </div>
              <h3 className="text-blue-600 font-semibold text-center text-xs lg:text-sm">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full border-4 border-cyan-300 bg-white flex items-center justify-center mb-4">
                <Image src="/images/study-abroad/logos/u-2.webp" alt="Bashkir State Medical University" width={80} height={80} className="object-contain w-14 h-14 lg:w-20 lg:h-20" />
              </div>
              <h3 className="text-blue-600 font-semibold text-center text-xs lg:text-sm">
