...
const Kyrgyzstan = () => {
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {/* Hero Section */}
      <div
        className="relative text-white py-15 md:py-32 lg:py-50 px-4 md:px-6 overflow-hidden flex items-center"
        style={{
        ...
        <div className="container mx-auto relative z-20">
          <div className="max-w-3xl">
            ...
            <p className="text-sm md:text-lg lg:text-[16px] text-white/90 font-medium max-w-2xl leading-relaxed">
              Turn your dream into reality with an MBBS in Kyrgyzstan, where
              quality education meets affordability and global recognition.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
          ...
          <div className="w-full lg:w-2/3 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-70 z-0 pointer-events-none overflow-hidden">
              <Image
                src="/images/study-abroad/flags/bg-kyrgyzstan.png"
                alt="Kyrgyzstan Flag"
                width={183}
                height={183}
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 md:space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
                <p>
                  Studying medicine in Kyrgyzstan is becoming increasingly
                  popular among foreign students seeking an affordable but
                  quality education. There are many renowned medical
                  institutions where students can learn medical courses in
                  English. With reasonable tuition fees, lower cost of living,
                  and state-of-the-art infrastructure, the academic environment
                  in Kyrgyzstan is very conducive for foreign students wishing
                  to practice medicine without any financial constraints.
                </p>

                <p>
                  Students will have access to experienced faculty members,
                  modernized laboratories, and ample opportunities for hands-on
                  learning, enabling them to hone their skills as physicians.
                  The admission procedure is not that complicated, campus life
                  is secure for all students, and degrees acquired from medical
                  schools in Kyrgyzstan are globally accepted.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className=" relative z-20 -mt-16 bg-gradient-to-b from-blue-50 to-white py-8 md:py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-4xl font-bold text-center mb-8 md:mb-12 px-4">
            ...
            <span className="text-blue-500">Medicine In Kyrgyzstan</span>
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
            {/* Kyrgyzstan Universities */}
            <Link href="https://www.radicaleducation.in/medical-faculty-asian-medical-institute" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
              <div className="w-[152px] h-[152px] md:w-[190px] md:h-[190px] flex items-center justify-center mb-2 md:mb-4">
                <Image
                  src="/images/study-abroad/logos/kyrgyzstan-1.png"
                  alt="Medical Faculty Asian Medical Institute"
                  width={190}
                  height={190}
              ...
              Bishkek Medical Faculty Asian Medical Institute
              </h3>
            </Link>

            <Link href="https://www.radicaleducation.in/osh-international-medical-university-kyrgyzstan" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
              <div className="w-[152px] h-[152px] md:w-[190px] md:h-[190px] flex items-center justify-center mb-2 md:mb-4">
                <Image
                  src="/images/study-abroad/logos/kyrgyzstan-2.png"
                  alt="Osh International Medical University, Kyrgyzstan"
                  width={190}
                  height={190}
                  className="object-contain"
                />
            ...
            <Link href="https://www.radicaleducation.in/jalal-abad-state-university-kyrgyzstan" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
              <div className="w-[152px] h-[152px] md:w-[190px] md:h-[190px] flex items-center justify-center mb-2 md:mb-4">
                <Image
                  src="/images/study-abroad/logos/kyrgyzstan-3.png"
                  alt="Jalal-Abad State University, Kyrgyzstan"
                  width={190}
                  height={190}
                  className="object-contain"
                />
            ...
            <Link href="https://www.radicaleducation.in/kyrgyz-state-medical-university" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
              <div className="w-[152px] h-[152px] md:w-[190px] md:h-[190px] flex items-center justify-center mb-2 md:mb-4">
                <Image
                  src="/images/study-abroad/logos/kyrgyzstan-4.png"
                  alt="Kyrgyz State Medical Academy, Kyrgyzstan"
                  width={190}
                  height={190}
                  className="object-contain"
                />
      ...
      <div className="bg-white py-8 md:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-gray-600 leading-relaxed space-y-4 text-sm md:text-base">
            <p>
              One of the major advantages of studying MBBS in Kyrgyzstan is that
              the mode of communication is English. This eliminates the
              communication barrier for Indian students. Lets take a look at
              some of the other reasons that one can consider before choosing
              medical studies in Kyrgyzstan:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                No Donation/Capitation Fees – A transparent and inexpensive
                admission process.
              </li>
              <li>
                Recognised Universities – The universities are internationally
                certified by NMC, WHO, and other international organizations.
              </li>
              <li>
                Simplified Admission Process – Simple admission process with
                easy documentation..
              </li>
              <li>
                Low Cost of Living – Low costs related to housing, meals, and
                living expenses.
              </li>
              <li>
                Quality Education – Well-equipped facilities, modern curriculum,
                and competent faculty members.
              </li>
              <li>
                Hands-On Experience in Early Years – Students gain clinical
                skills right from their first year.
              </li>
              <li>
                Safe and Student-Friendly Atmosphere – A comfortable environment
                for foreigners.
              </li>
              <li>
                Helpful in FMGE/NExT Preparation – Universities help in
                preparing for licensing exams in India.
              </li>
            </ul>
          </div>
        </div>
