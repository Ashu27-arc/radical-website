...
const Russia = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative text-white py-20 sm:py-28 md:py-40 lg:py-50 px-4 md:px-6 overflow-hidden" style={{
      ...
      <div className="container mx-auto py-8 md:py-16 px-4 md:px-6">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
          ...
          <div className="w-full lg:w-1/2 relative flex flex-col lg:flex-row justify-center items-center mt-8 lg:mt-16">
            <div className="bg-[#E3F4F3] rounded-lg shadow-lg p-6 md:p-8 relative overflow-hidden w-full max-w-md lg:w-90 h-auto md:h-60 flex flex-col justify-center items-center text-center">
              ...
              <div className="relative z-10 flex flex-col justify-center items-center h-full w-full">
                <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4 md:mb-6 leading-tight text-center md:text-left md:text-justify">
            ...
            <div className="mt-6 lg:mt-0 lg:absolute lg:-right-28 lg:top-1/2 lg:transform lg:-translate-y-1/2 z-20">
              <Image
                src="/images/study-abroad/main-content.webp"
                alt="Medical consultant"
                width={300}
                height={300}
                className="object-contain w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-[300px] lg:h-[300px]"
              />
            </div>
          </div>
        </div>
