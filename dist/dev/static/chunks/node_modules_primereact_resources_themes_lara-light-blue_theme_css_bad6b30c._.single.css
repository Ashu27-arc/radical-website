...
@font-face {
  ...
  src: url("../media/InterVariable.b9dc6a4a.woff2") format("woff2");
}
...
@font-face {
  ...
  src: url("../media/InterVariable-Italic.ad9ad40c.woff2") format("woff2");
}
...
@layer primereact {
  * {
  ...
  :is(.p-togglebutton:not(.p-disabled):has(.p-togglebutton-input:hover):not(.p-highlight) .p-button .p-button-icon-left, .p-togglebutton:not(.p-disabled):has(.p-togglebutton-input:hover):not(.p-highlight) .p-button .p-button-icon-right) {
    color: #374151;
  }
  ...
  :is(.p-togglebutton:not(.p-disabled):has(.p-togglebutton-input:hover).p-highlight .p-button .p-button-icon-left, .p-togglebutton:not(.p-disabled):has(.p-togglebutton-input:hover).p-highlight .p-button .p-button-icon-right) {
    color: #fff;
  }
...
/*# sourceMappingURL=node_modules_primereact_resources_themes_lara-light-blue_theme_css_bad6b30c._.single.css.map*/